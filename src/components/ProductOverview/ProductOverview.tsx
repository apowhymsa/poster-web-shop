      ...
      <div className="flex flex-col gap-y-3 w-full">
        ...
        {tab === 2 && (
          <div className="flex flex-col gap-y-8 max-h-[300px] overflow-y-auto px-1 py-2">
            ...
            <div className="flex gap-x-4 border-b pb-8">
              <Image
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <div>
                  <span>
                    ...
                    Asperiores commodi corporis cum debitis, exercitationem,
                    illum laboriosam laborum nisi numquam omnis placeat possimus
                    quam quas quasi quia quibusdam similique sunt totam.
                  </span>
                </div>
              </div>
            </div>
